...
public class HttpClientUtil {
    ...
    public static String doGet(String url) {
        ...
        try {
            ...
            // 设置配置请求参数
            RequestConfig requestConfig = RequestConfig.custom().setConnectTimeout(20000)// 连接主机服务超时时间
    ...
    public static String doPost(String url, Map<String, Object> paramMap) {
        ...
        // 配置请求参数实例
        RequestConfig requestConfig = RequestConfig.custom().setConnectTimeout(2000)// 设置连接主机服务超时时间
